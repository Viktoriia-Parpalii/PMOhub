...
export const getPriorityDefinition = (
  priorityId: string | undefined,
  priorities: PriorityDef[],
): PriorityDef | undefined => priorities.find((item) => item.id === priorityId);
...
export const getPriorityBadgeStyle = (
  ...
  const color =
    getPriorityDefinition(priorityId, priorities)?.color ?? fallbackColor;
  return {
    color,
...
export const getPriorityBadgeClass = (_priorityId?: string): string =>
