    ...
    >
      ...
      <div className="absolute top-2 right-2 flex flex-col opacity-0 group-hover:opacity-100 transition-opacity z-10 bg-white/95 backdrop-blur shadow-lg border border-slate-200 rounded-lg py-1.5 px-2.5">
        ...
        <div className="flex items-center gap-2">
          <button 
            onClick={(e) => { e.stopPropagation(); updateProject(project.id, { health_status: 'DEFAULT' as any }) }} 
          ...
          />
          <button 
            onClick={(e) => { e.stopPropagation(); updateProject(project.id, { health_status: 'GREEN' as any }) }} 
          ...
          />
          <button 
            onClick={(e) => { e.stopPropagation(); updateProject(project.id, { health_status: 'YELLOW' as any }) }} 
          ...
          />
          <button 
            onClick={(e) => { e.stopPropagation(); updateProject(project.id, { health_status: 'RED' as any }) }} 
      ...
      <div className="ml-2 grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-4 mb-3 flex-1">
        ...
        <div className="flex justify-between items-center text-xs sm:text-sm">
          ...
          <span className={`rounded border px-2 py-0.5 text-xs font-bold ${getPriorityBadgeClass(project.priority)}`}>
