...
export const SYSTEM_MESSAGES = {
  ...
  initiatives: {
    ...
    archivedTransferDenied:
      "Неможливо перенести в архівний період. Оберіть поточний або майбутній квартал.",
    yearHasQuarterCards:
